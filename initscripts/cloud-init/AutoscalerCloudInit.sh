...
/bin/sed -i "s;XXXXCUSTOM_FIREWALL_PORT_SETTINGSXXXX;${custom_firewall_port_settings};g" ${BUILD_HOME}/runtimedata/${CLOUDHOST}/${BUILD_IDENTIFIER}/cloud-init/autoscaler.yaml
