...
WEBSITE_URLP="`${BUILD_HOME}/helperscripts/GetVariableValue.sh WEBSITEURL`"
...
then
    status "Building from backup, username and password set to already existing values"
    ...
    status "Not building from backup, username and password being freshly generated"
