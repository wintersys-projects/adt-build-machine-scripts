...
then
        ...
        ${BUILD_HOME}/providerscripts/datastore/operationsGetFromDatastore.sh ${snap_bucket}/credentials.dat ${BUILD_HOME}/runtimedata/wholemachinesnapshots/${WEBSITE_URL}/snapshots
