...
then
        ...
        ${BUILD_HOME}/providerscripts/datastore/operations/GetFromDatastore.sh "snap" "snapshot_ids.dat" "${BUILD_HOME}/runtimedata/wholemachinesnapshots/${WEBSITE_URL}/snapshots"
        ${BUILD_HOME}/providerscripts/datastore/operations/GetFromDatastore.sh "snap" "db_credentials.dat.candidate" "${BUILD_HOME}/runtimedata/wholemachinesnapshots/${WEBSITE_URL}/snapshots"
        ${BUILD_HOME}/providerscripts/datastore/operations/GetFromDatastore.sh "snap" "db_credentials.dat" "${BUILD_HOME}/runtimedata/wholemachinesnapshots/${WEBSITE_URL}/snapshots"
        ${BUILD_HOME}/providerscripts/datastore/operations/GetFromDatastore.sh "snap" "credentials.dat" "${BUILD_HOME}/runtimedata/wholemachinesnapshots/${WEBSITE_URL}/snapshots"
