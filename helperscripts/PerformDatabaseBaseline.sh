...
if ( [ "`${BUILD_HOME}/providerscripts/git/GitLSRemote.sh ${APPLICATION_REPOSITORY_PROVIDER} ${APPLICATION_REPOSITORY_USERNAME} ${APPLICATION_REPOSITORY_USERNAME} ${APPLICATION_DB_REPOSITORY} ${APPLICATION_REPOSITORY_TOKEN}`" = "" ] )
then
