...
do
	...
	then
		...
		then
			...
			then
				${BUILD_HOME}/providerscripts/datastore/operations/DeleteFromDatastore.sh "config" "autoscalerpublicips" "local"
			fi
			if ( [ "`${BUILD_HOME}/providerscripts/datastore/operations/ListFromDatastore.sh "config" "autoscalerips/*"`" != "" ] )
			then
				${BUILD_HOME}/providerscripts/datastore/operations/DeleteFromDatastore.sh "config" "autoscalerips" "local"
			fi
		fi
