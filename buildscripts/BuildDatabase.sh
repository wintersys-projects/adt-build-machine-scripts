		...
		then
                ...
                then
                        ...
                        then
                                ...
                                /usr/bin/ssh -q -p ${SSH_PORT} -i ${BUILD_KEY} ${OPTIONS} ${SERVER_USER}@${db_active_ip} "${SUDO} /usr/bin/tar xvf /tmp/database_backup.tar --keep-newer-files -C /"
				...
				/usr/bin/ssh -q -p ${SSH_PORT} -i ${BUILD_KEY} ${OPTIONS} ${SERVER_USER}@${db_active_ip} "${SUDO} /bin/mv /home/${SERVER_USER} /home/${SERVER_USER}.holder ; ${SUDO} /bin/rm -r /home/X*X ; ${SUDO} /bin/mv /home/${SERVER_USER}.holder /home/${SERVER_USER}"
   			else
