...
On the build machine repository, add the new variable to **${BUILD_HOME}/builddescriptors/envdump.dat**  
To make the new variable available to the autoscaler  
On the build machine repository, add the new variable to **${BUILD_HOME}/builddescriptors/autoscalerscp.dat** 
To make the new variable available to the webserver  
On the build machine repository, add the new variable to **${BUILD_HOME}/builddescriptors/webserverscp.dat**  
To make the new variable available to the database  
On the build machine repository, add the new variable to **${BUILD_HOME}/builddescriptors/databasescp.dat**  
