...
>     ./adt-build-machine-scripts/templatedconfigurations/templates/aws/aws1.description and the hardcore method.
...
![](../../images/aws/aws-virgin-hardcore/aws1.png "AWS Tutorial Image 1")  
...
![](../../images/aws/aws-virgin-hardcore/aws2.png "AWS Tutorial Image 2")  

And click "Create Access Key"
![](../../images/aws/aws-virgin-hardcore/aws3.png "AWS Tutorial Image 3")  
...
You then need the url that you want to use for your website. If you don't have a DNS URL for your website, you need to purchase one and set the nameservers to aws as described in ./adt-build-machine-scripts/blob/master/doco/AgileToolkitDeployment/Nameservers.md
...
>     vi ./adt-build-machine-scripts/templatedconfigurations/templates/aws/aws1.tmpl
...
>     /bin/cp ./adt-build-machine-scripts/templatedconfigurations/templates/aws/aws1.tmpl ./adt-build-machine-scripts/overridescripts/aws1override.tmpl  
...
Now you have your userdata script take a copy of the entirity of it using copy and paste and then follow [these](../../../doco/Tutorials/aws/buildmachine-hardcore.md) instructions PASTING THE SCRIPT YOU HAVE JUST COPIED INTO THE USERDATA AREA OF YOUR AWS MACHINE INSTEAD OF THE MODIFIED TEMPLATE. The build machine will then install **AND**  run the agile deployment toolkit. This is just an alternative method to the expedited build process which you may or may not perfer.
