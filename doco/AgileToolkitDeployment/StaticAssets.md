...
2. Mount a file system using S3FS or EFS as your assets directory.(PERSIST_ASSETS_TO_CLOUD="1")
3. Write the assets to the webserver's file system as they are generated by the application and then promptly move them to the S3 assets bucket and use the assets bucket as a CDN origin in your application (PERSIST_ASSETS_TO_CLOUD="2")
