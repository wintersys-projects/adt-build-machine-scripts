...
then
        ...
        then
                ...
                then
                        /bin/sed -i "s/XXXXXAUTOSCALER_HOSTNAMEXXXX/${server_name};g" ${BUILD_HOME}/runtimedata/${CLOUDHOST}/${BUILD_IDENTIFIER}/cloud-init/autoscaler.yaml
        ...
        then
                ...
                then
                        /bin/sed -i "s/XXXXXWEBSERVER_HOSTNAMEXXXX/${server_name};g" ${BUILD_HOME}/runtimedata/${CLOUDHOST}/${BUILD_IDENTIFIER}/cloud-init/webserver.yaml
        ...
        then
                ...
                then
                        /bin/sed -i "s/XXXXXDATABASE_HOSTNAMEXXXX/${server_name};g" ${BUILD_HOME}/runtimedata/${CLOUDHOST}/${BUILD_IDENTIFIER}/cloud-init/database.yaml
